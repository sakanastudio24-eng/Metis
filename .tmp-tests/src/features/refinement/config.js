...
exports.PLUS_IMPACT_LABELS = exports.PLUS_LABELS = exports.PLUS_QUESTION_DEFINITIONS = exports.PLUS_CORE_KEYS = void 0;
exports.buildStackFallbackQuestionDefinitions = buildStackFallbackQuestionDefinitions;
exports.PLUS_CORE_KEYS = [
    "hostingProvider",
    "monthlyVisits",
    "appType"
];
exports.PLUS_QUESTION_DEFINITIONS = [
    {
        key: "appType",
        label: "App Type",
        ...
        whyItMatters: "A route that looks heavy on a portfolio may be acceptable on a dashboard or marketplace.",
        group: "Stack",
        required: true,
        options: [
    ...
    },
    {
        ...
        whyItMatters: "The same request pattern means different things on different hosts and billing models.",
        group: "Stack",
        required: true,
        options: [
    ...
    },
    {
        ...
        whyItMatters: "A watch score on a free plan can be more urgent than the same score on an enterprise plan.",
        group: "Stack",
        required: false,
        options: [
    ...
    },
    {
        ...
        whyItMatters: "A 6-page site and a 500-page app can show similar issues while needing very different cleanup strategies.",
        group: "Traffic",
        required: false,
        options: [
    ...
    },
    {
        ...
        whyItMatters: "Raw page weight means little without traffic. Volume determines whether a small issue is negligible or expensive.",
        group: "Traffic",
        required: true,
        options: [
    ...
    },
    {
        ...
        whyItMatters: "A problem on a homepage or other hot route deserves faster cleanup than the same issue on a low-traffic admin path.",
        group: "Traffic",
        required: false,
        options: [
            { value: "yes", label: "Yes" },
    ...
    },
    {
        ...
        whyItMatters: "Heavy request activity is more expected on highly dynamic apps, but repeated work can still be expensive.",
        group: "Traffic",
        required: false,
        options: [
    ...
    },
    {
        ...
        whyItMatters: "Repeated calls are much worse if they hit paid services such as search, maps, auth, or email vendors.",
    ...
    },
    {
        ...
        whyItMatters: "A single AI call on submit is very different from AI usage on every keystroke or repeated action.",
        group: "Cost sensitivity",
        required: false,
        options: [
    ...
    },
    {
        ...
        whyItMatters: "A photography or media product should be optimized differently than a docs site or admin tool.",
        group: "Cost sensitivity",
        required: false,
        options: [
    ...
    },
    {
        ...
        whyItMatters: "Knowing whether optimization tooling already exists changes whether the best next move is adoption, tuning, or deeper cleanup.",
        group: "Cost sensitivity",
        required: false,
        options: [
            { value: "yes", label: "Yes" },
...
function buildStackFallbackQuestionDefinitions(missingGroups) {
        ...
        switch (group) {
            case "framework":
                return {
                    ...
                    whyItMatters: "Framework context changes which fixes are realistic and which patterns are normal on the page.",
                    group: "Stack",
                    required: false,
                    options: [
            ...
            case "hostingCdn":
                return {
                    ...
                    whyItMatters: "The host and CDN layer changes what repeated requests, caching, and heavy assets actually cost.",
                    group: "Stack",
                    required: false,
                    options: [
            ...
            case "aiProvider":
                return {
                    ...
                    whyItMatters: "Different AI vendors change per-request cost and what optimization steps matter most.",
                    group: "Stack",
                    required: false,
                    options: [
            ...
            case "analytics":
                return {
                    ...
                    whyItMatters: "Analytics, ad-tech, and RUM vendors add third-party spend and execution overhead that should be attributed correctly.",
                    group: "Stack",
                    required: false,
                    options: [
            ...
            default:
                return {
                    ...
                    whyItMatters: "Payment providers often bring extra scripts and route-specific costs that should be attributed correctly.",
                    group: "Stack",
                    required: false,
                    options: [
