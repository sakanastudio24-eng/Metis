...
exports.TECHNOLOGY_FINGERPRINTS = void 0;
const BRAND = {
    react: "#61dafb",
    nextjs: "#9ca3af",
    vue: "#41b883",
...
function hostingFingerprint(id, label, minScore, patterns, brandColor, providerKind, implies) {
    return {
        id,
        label,
        group: "hostingCdn",
...
exports.TECHNOLOGY_FINGERPRINTS = [
    {
        id: "react",
        label: "React 18",
        group: "framework",
    ...
    hostingFingerprint("vercel", "Vercel", 4, [
    ...
    ], BRAND.vercel, "app-platform"),
    hostingFingerprint("cloudflare", "Cloudflare CDN", 4, [
    ...
    hostingFingerprint("cloudfront", "CloudFront", 4, [
        { source: "host", keyIncludes: ["cloudfront.net"], minWeight: 4 },
        { source: "resource", keyIncludes: ["x-amz-cf"], minWeight: 3 }
    ], BRAND.cloudfront, "cloudfront", ["aws"]),
    hostingFingerprint("aws-s3", "AWS S3", 4, [{ source: "host", keyIncludes: [".s3.amazonaws.com", ".s3.", "s3.amazonaws.com"], minWeight: 4 }], BRAND.aws, "s3", ["aws"]),
    hostingFingerprint("aws-api-gateway", "AWS API Gateway", 4, [{ source: "host", keyIncludes: ["execute-api."], minWeight: 4 }], BRAND.aws, "api-gateway", ["aws"]),
    hostingFingerprint("aws", "AWS", 4, [
    ...
    ], BRAND.aws, "aws-generic"),
    hostingFingerprint("digitalocean", "DigitalOcean", 4, [
        { source: "host", keyIncludes: ["ondigitalocean.app", "digitaloceanspaces.com", "digitaloceanspaces"], minWeight: 4 }
    ], BRAND.digitalocean, "app-platform"),
    hostingFingerprint("linode", "Linode", 4, [{ source: "host", keyIncludes: ["linodeobjects.com", "linodeusercontent.com"], minWeight: 4 }], BRAND.linode, "vps"),
    hostingFingerprint("vultr", "Vultr", 4, [{ source: "host", keyIncludes: ["vultrusercontent.com", "vultrobjects.com"], minWeight: 4 }], BRAND.vultr, "vps"),
    hostingFingerprint("gcp", "Google Cloud", 4, [{ source: "host", keyIncludes: ["run.app", "appspot.com", "googleapis.com"], minWeight: 4 }], BRAND.gcp, "container"),
    hostingFingerprint("azure", "Azure", 4, [{ source: "host", keyIncludes: ["azurewebsites.net", "windows.net", "azureedge.net"], minWeight: 4 }], BRAND.azure, "app-platform"),
    hostingFingerprint("heroku", "Heroku", 4, [{ source: "host", keyIncludes: ["herokuapp.com", "herokudns.com"], minWeight: 4 }], BRAND.heroku, "app-platform"),
    {
        id: "openai",
        label: "OpenAI GPT-4",
        group: "aiProviders",
